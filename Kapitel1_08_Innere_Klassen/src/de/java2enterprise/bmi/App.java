...
import de.java2enterprise.bmi.controller.BMIRechnerFabrik;
...
public class App {
	...
	private void verarbeite() {
		System.out.print("BMI [1=Winter 2=Sommer]");
		int auswahl = scanner.nextInt();
		BMIRechner rechner = BMIRechnerFabrik.createInstance(auswahl);
