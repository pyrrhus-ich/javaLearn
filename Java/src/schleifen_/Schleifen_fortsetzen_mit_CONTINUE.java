...
/**
 * <p>
 * Mit continue ist es m�glich fehleingaben abzufangen
 *</p>
 */
public class Schleifen_fortsetzen_mit_CONTINUE {
	...
	public static void main(String[] args) {
		...
		while(true) {
			System.out.println("Sch�tze eine Zahl zwschen 1 und 5\n");
			int guess = new java.util.Scanner(System.in).nextInt();
		// ab hier wird gepr�ft ob die Zahl im Bereich liegt
		if (guess <1 || guess >5) {
			...
			System.out.println("Du hast zu hoch gesch�tzt");
		}
